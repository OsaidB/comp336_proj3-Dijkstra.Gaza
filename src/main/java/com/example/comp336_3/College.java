...
//	private double y;
	...
	public College(String line) {
		...
		ImageView vi = new ImageView(new Image("G:\\My Drive\\UNIVERSITY\\3rd year\\2nd Semester\\COMP336\\Projects\\P3\\location-pin (1).png"));
		vi.setFitHeight(16);
		vi.setFitWidth(16);
		...
		radioButton.setOnAction(o -> {
			if (Main.numOfPointChoice == 0) {
				ImageView vi0 = new ImageView(new Image("G:\\My Drive\\UNIVERSITY\\3rd year\\2nd Semester\\COMP336\\Projects\\P3\\location-pin.png"));
				vi0.setFitHeight(16);
				vi0.setFitWidth(16);
			...
			if (Main.numOfPointChoice == 1) {
				ImageView vi0 = new ImageView(new Image("G:\\My Drive\\UNIVERSITY\\3rd year\\2nd Semester\\COMP336\\Projects\\P3\\location-pin (2).png"));
				vi0.setFitHeight(16);
				vi0.setFitWidth(16);
				radioButton.setGraphic(vi0);
			}
